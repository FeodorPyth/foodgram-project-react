    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', colorfield.fields.ColorField(choices=[('#000000', 'черный'), ('#C0C0C0', 'серебристый'), ('#808080', 'серый'), ('#8B4513', 'коричневый'), ('#800000', 'бордовый'), ('#FF0000', 'красный'), ('#800080', 'фиолетовый'), ('#FF00FF', 'фуксия'), ('#008000', 'зеленый'), ('#00FF00', 'лаймовый'), ('#808000', 'оливковый'), ('#ADFF2F', 'желто-зеленый'), ('#000080', 'темно-синий'), ('#0000FF', 'синий'), ('#008080', 'бирюзовый'), ('#00FFFF', 'аквамарин')], default='#000000', help_text='Выберите цвет тега.', image_field=None, max_length=13, samples=None, unique=True, verbose_name='Цветовой код тега')),
